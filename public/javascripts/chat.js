...
var htmlEntities, name, pageTitleNotification, playerIndex;
...
$(function() {
  var $alterCardBlank, $alterCardCFO, $alterCardFaceDown, $alterCardHR, $alterCardManager, $alterCardOneUpper, $alterCardVP, $content, $field, $gainCredButton, $joinButton, $joinGame, $loseCredButton, $name, $playGame, $sendButton, $startButton, $startGame, $username, $window, joinGame, logs, selfIndex, sendMessage, socket, windowFocus;
  $window = $(window);
  windowFocus = true;
  ...
  socket.on('board:update', function(data) {
    var $emptyPanels, $player, $playerCards, $playerCredibility, $playerPanel, $playerTitle, card, cardIndex, player, players, _i, _j, _ref;
    if (data == null) {
      data = {};
    }
    if (data.players) {
